...
export const grammarTopics: GrammarTopic[] = [
  ...
  },
  {
    ...
    details: {
      ...
      description: 'เรียนรู้การใช้กริยาเติม -ing (Gerund) และ to + V1 (Infinitive) ว่าเมื่อไหร่ควรใช้อันไหน',
      subtopics: [
        {
          id: 'gerund',
          name: 'Gerund (V-ing)',
          usage: 'กริยาเติม -ing ที่ทำหน้าที่เป็นคำนาม (Subject/Object) หรือตามหลัง Preposition และกริยาเฉพาะกลุ่ม (enjoy, avoid, mind, finish)',
          examples: [
            '**Reading** is fun. (การอ่านเป็นเรื่องสนุก - ประธาน)',
            'I enjoy **swimming**. (ฉันชอบว่ายน้ำ - กรรมหลัง enjoy)',
            'He is good at **drawing**. (เขาเก่งวาดรูป - หลัง preposition at)'
          ]
        },
        {
          id: 'infinitive',
          name: 'Infinitive (to + V)',
          usage: 'กริยาช่อง 1 ที่มี to นำหน้า ใช้ตามหลังกริยาเฉพาะกลุ่ม (want, hope, decide, plan) หรือบอกจุดประสงค์',
          examples: [
