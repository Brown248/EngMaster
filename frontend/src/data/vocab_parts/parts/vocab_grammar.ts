...
export const grammarWords: VocabWord[] = [
  ...
  { word: "Moreover", meaning: "ยิ่งไปกว่านั้น", partOfSpeech: "adv.", example: "The report is long; moreover, it is boring.", category: "Academic", level: "Advanced", usage: "Work" },
  { word: "Nevertheless", meaning: "อย่างไรก็ตาม", partOfSpeech: "adv.", example: "It was risky; nevertheless, he tried.", category: "Academic", level: "Advanced", usage: "Work" },
