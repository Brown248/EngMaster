...
export const specialWords: VocabWord[] = [
  ...
  { word: "Burn the midnight oil", meaning: "ทำงานดึก", partOfSpeech: "idiom", example: "He is burning the midnight oil.", category: "General", special: "Idioms", level: "Advanced", usage: "Work" },
  ...
  { word: "Implement", meaning: "นำไปปฏิบัติ", partOfSpeech: "v.", example: "Implement the plan.", category: "Business", special: "TOEIC", level: "Advanced", usage: "Work" },
  { word: "Significant", meaning: "สำคัญ, อย่างมาก", partOfSpeech: "adj.", example: "Significant improvement.", category: "Academic", special: "TOEIC", level: "Advanced", usage: "Work" }
];